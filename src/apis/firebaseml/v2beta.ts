...
export namespace firebaseml_v2beta {
   ...
   */
  export interface Schema$GroundingAttribution {
    /**
     ...
     */
    retrievedContext?: Schema$RetrievedContext;
    /**
  ...
  export interface Schema$GroundingMetadata {
     ...
     */
    groundingAttributions?: Schema$GroundingAttribution[];
    /**
   ...
   */
  export interface Schema$RetrievedContext {
    /**
     * Output only. Title of the attribution.
     */
    title?: string | null;
